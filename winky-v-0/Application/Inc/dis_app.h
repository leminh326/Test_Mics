...
/* Exported macros -----------------------------------------------------------*/
#define DISAPP_MANUFACTURER_NAME              "MAINBOT"
#define DISAPP_MODEL_NUMBER                   "WINKY-1.0"
#define DISAPP_SERIAL_NUMBER                  "1.0"
#define DISAPP_HARDWARE_REVISION_NUMBER       "1.0.0"
#define DISAPP_FIRMWARE_REVISION_NUMBER       "1.0.0"
#define DISAPP_SOFTWARE_REVISION_NUMBER       "1.0.0"
