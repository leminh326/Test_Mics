#ifndef AUDO_CODEC_TLV300DAC31_REGISTERS
#define AUDO_CODEC_TLV300DAC31_REGISTERS
...
// Source from https://git.kernel.org/pub/scm/linux/kernel/git/arm/arm-soc.git/tree/sound/soc/codecs/

#define AIC31XX_REG(page, reg)	((page * 0) + reg)
...
#define AIC31XX_MIXDAC		AIC31XX_REG(0, 35) /* Configure LDAC and RDAC roots*/ 	
...
#define AIC31XX_VOLCTRL		AIC31XX_REG(0, 116) /* Control Volume GPIO */
...
#define AIC31XX_ANALOGSPK	AIC31XX_REG(1, 38) /* Analog Vol to Class-D Speaker (SPK) Driver */
#define AIC31XX_HPLGAIN		AIC31XX_REG(1, 40) /* HPL Driver */
#define AIC31XX_HPRGAIN		AIC31XX_REG(1, 41) /* HPR Driver */
#define AIC31XX_SPKGAIN		AIC31XX_REG(1, 42) /* Class-D Speaker (SPK) Driver */
...
/* Volume */
#define SPK_ANA_VOL_ENABLE  (BIT(7))
#define SPK_ANA_VOL_MASK  (BIT_MASK(7))
#define SPK_ANA_VOL(val)  (((val) & SPK_ANA_VOL_MASK) | \
    SPK_ANA_VOL_ENABLE)
#define SPK_ANA_VOL_MAX   (0)
#define SPK_ANA_VOL_DEFAULT (64)
#define SPK_ANA_VOL_MIN   (127)
#define SPK_ANA_VOL_MUTE  (SPK_ANA_VOL_MIN | ~SPK_ANA_VOL_ENABLE)
#define SPK_ANA_VOL_LOW_THRESH  (105)
#define SPK_ANA_VOL_FLOOR (144)

#ifdef __cplusplus
}
#endif

#endif // AUDO_CODEC_TLV300DAC31_REGISTERS
