...
int main(void)
{
  ...
  loggerQueueHandle = osMessageQueueNew (16, sizeof(logger_buffer_t), &loggerQueue_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, FLASH_CS_Pin|ToF_xSHUT_Pin|EEPROM_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, EAR_R_Pin|RST_IQS572_AUDIO_GPIO1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(AUDIO_RST_GPIO_Port, AUDIO_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RDY_IQS572_WAKEUP2_Pin RDY_I2C3_Pin */
  GPIO_InitStruct.Pin = RDY_IQS572_WAKEUP2_Pin|RDY_I2C3_Pin;
  ...
  GPIO_InitStruct.Pin = FLASH_CS_Pin|ToF_xSHUT_Pin|EEPROM_CS_Pin;
